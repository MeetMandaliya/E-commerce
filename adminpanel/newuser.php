    ...
    <div class="card">
      ...
      <div class="card-body register-card-body">
        ...
        <form action="code.php" method="post">
          ...
          <div class="input-group mb-3">
            <input type="phone" class="form-control" placeholder="Phone no" name="newphone" required>
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3">
            <input type="password" class="form-control" placeholder="Retype password" name="newconfirmpassword" required>
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-lock"></span>
              </div>
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-4">
              <button type="submit" class="btn btn-primary btn-block" name="newuser">Register</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
