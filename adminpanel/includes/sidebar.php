    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item">
        <select id="userOptions" class="form-control bg mb-4">
          ...
          <option value="register.php">Register Users <i class="fas fa-chevron-down text-white" id="userArrow"></i></option>
      ...
      <select id="categoryOptions" class="form-control bg mb-4">
        <option selected class="bg" value="category.php">Categories <i class="fas fa-chevron-down text-white" id="categoryArrow"></i></option>
      </select>
    </li>
    <li class="nav-item">
      <select id="categoryOptions" class="form-control bg mb-4">
        <option selected class="bg" value="subcategory.php">Subcategories <i class="fas fa-chevron-down text-white" id="categoryArrow"></i></option>
      ...
      <li class="nav-item form-control bg mb-4">
